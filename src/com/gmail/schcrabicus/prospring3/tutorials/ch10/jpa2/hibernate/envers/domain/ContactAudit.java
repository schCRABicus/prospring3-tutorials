...
public class ContactAudit implements Auditable<String, Long>, Serializable {
    ...
    public String toString() {
        return "ContactAudit{" +
                ...
                ", version=" + version +
                ", createdBy='" + createdBy + '\'' +
                ", createdDate=" + /*createdDate*/DateTimeFormat.forPattern("YYYY-dd-MM - HH:mm:ss, SSS").print(new DateTime(createdDate)) +
                ", lastModifiedBy='" + lastModifiedBy + '\'' +
                ", lastModifiedDate=" + /*lastModifiedDate*/DateTimeFormat.forPattern("YYYY-dd-MM - HH:mm:ss, SSS").print(new DateTime(lastModifiedDate)) +
                '}';
    }
}
