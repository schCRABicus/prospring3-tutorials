...
public class launcher {
    ...
    public static void main(String []args){
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("classpath:**/app-context-annotations.xml");

        MessageProvider messageProvider = applicationContext.getBean("messageProvider", MessageProvider.class);
        System.out.println("Annotation based : " + messageProvider.getMessage());
