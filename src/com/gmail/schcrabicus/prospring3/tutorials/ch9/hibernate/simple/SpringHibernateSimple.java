package com.gmail.schcrabicus.prospring3.tutorials.ch9.hibernate.simple;
 ...
 */
public class SpringHibernateSimple {

    private static Logger log = Logger.getLogger(SpringHibernateSimple.class);
